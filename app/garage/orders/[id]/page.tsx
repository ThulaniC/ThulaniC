...
import { getOrderDetails, getOrdersByLocation, getGarageById } from "@/lib/db"
...
export default async function OrderDetailsPage({ params }: { params: { id: string } }) {
  ...
  // Get all orders for this garage
        ...
        <Card>
          ...
          <CardFooter className="flex justify-between">
            <Button variant="outline" asChild>
              <Link href="/garage/orders">Back to All Orders</Link>
            </Button>
